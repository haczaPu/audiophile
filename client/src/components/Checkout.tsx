...
const Checkout = ({
  ...
  const vat: number = Math.floor((totalPrice * 20) / 100);
  const grandtotal: number = totalPrice + shipping;
            ...
            <form className="docs-wrapper" onSubmit={onSubmit}>
              ...
              <div className="summary">
                ...
                <div className="summary__product-list">
                  {cartItems.map((item: ItemInCart, i: number) => (
                    <div key={i} className="summary-item">
                      ...
                      <div className="summary-item__quantity">x{item.qty}</div>
                    </div>
                  ))}
                </div>
                ...
                <div className="summary__cost">
                  ...
                  <div className="cost__value">$ {shipping}</div>
                </div>
                <div className="summary__cost">
                  <div className="cost__title">VAT(Included)</div>
                  <div className="cost__value">$ {vat.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</div>
                </div>
                <div className="summary__cost summary__cost--grand">
                  <div className="cost__title">GRAND TOTAL</div>
                  <div className="cost__value typo--orange">
